package edu.cit.sabornido.rentease.features.auth;

import edu.cit.sabornido.rentease.core.config.JwtUtil;
import edu.cit.sabornido.rentease.core.exception.AppException;
import edu.cit.sabornido.rentease.features.auth.dto.AuthResponse;
import edu.cit.sabornido.rentease.features.auth.dto.RegisterRequest;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest req) {
        ...
        return AuthResponse.builder()
            .user(new AuthResponse.UserInfo(user.getId(), user.getEmail(), user.getFirstname(), user.getLastname(), user.getRole().name()))
